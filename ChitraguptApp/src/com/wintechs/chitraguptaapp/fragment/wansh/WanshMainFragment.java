package com.wintechs.chitraguptaapp.fragment.wansh;
...
public class WanshMainFragment extends BaseFragment implements ActionBar.TabListener {
	...
	static {
		...
		chalisaTabs.add("Heirarchi");
		chalisaTabs.add("Description");
	}
	...
	public static class AppSectionsPagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int i) {
			...
			switch (i) {
			case 0:
				return TabFragment.newInstance(i, ChitraguptaEnum.WANSH);
			case 1:
				return TabFragment.newInstance(i, ChitraguptaEnum.WANSH);

			default:
				// The other sections of the app are dummy placeholders.
				return TabFragment.newInstance(0, ChitraguptaEnum.WANSH);
			}
		}
